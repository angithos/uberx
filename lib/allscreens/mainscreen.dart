...
void locatePosition()async{
 ...
 Position position =await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high,forceAndroidLocationManager:true);
  ...
  CameraPosition cameraPosition=new CameraPosition(target: latlnPosition,zoom: 16.0);
...
Future<Position> determinePosition() async {
  ...
  CameraPosition cameraPosition=new CameraPosition(target: latlnPosition,zoom: 12.0);
  newGoogleMapController.animateCamera(CameraUpdate.newCameraPosition(cameraPosition));
    ...
    return Scaffold(
        ...
        body: Stack(
          children: [
            Expanded(
              child: GoogleMap(
                padding: EdgeInsets.only(bottom: paddingForMap),
